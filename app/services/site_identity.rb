class SiteIdentity
  ...
  PRIMARY = Site.new(
    ...
    copy: {
      ...
      nav_help: "Help",
      statistics_intro: "Participation, knowledge weighting and recorded changes of opinion across the published questions.",
  ...
  ALTERNATIVE = Site.new(
    ...
    copy: {
      ...
      statistics_intro: "See how many people have taken part, what difference factual knowledge makes, and how views have changed.",
