...
GREY_BELT_HOUSING_FACTS = FactBank.build([
  ...
  [ "When deciding whether English planning policy should require suitable grey-belt land to be released for housing where local need cannot otherwise be met, what judgement is ultimately required?", [ "Whether every green field is ecologically identical", "Whether housing need and affordable provision justify mandatory release of suitable low-contribution land despite delivery and openness costs", "Whether England should prohibit private housing", "Whether planning decisions need evidence" ], 1,
